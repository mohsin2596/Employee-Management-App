...
public class JuniorCompletedTaskAdapter extends BaseAdapter implements Filterable {
    ...
    public JuniorCompletedTaskAdapter(Context _context, ArrayList<Task> tasksList){
        context = _context;
