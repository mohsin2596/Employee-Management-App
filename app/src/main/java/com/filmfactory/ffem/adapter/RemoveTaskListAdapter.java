...
public class RemoveTaskListAdapter extends BaseAdapter implements Filterable {
    ...
    public RemoveTaskListAdapter(Context _context, ArrayList<Task> tasksList){
        context = _context;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (currRow == null){
            currRow = layoutInflater.inflate(R.layout.remove_task_item,viewGroup,false);
        }
        ...
        Button removeButton = currRow.findViewById(R.id.removeTask);
            ...
            public void onClick(View view) {
                ...
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        taskDBO.removeTask(filteredList.get(index));
                        allTasks.remove(filteredList.get(index));
